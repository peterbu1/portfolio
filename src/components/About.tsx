  ...
  return (
    <motion.div
      ...
      <div className='space-y-10 px-0 md:px-10'>
        ...
        <p className="text-base">I&apos;m Peter. I am a new graduate from Temple University with a major in Information Science &amp; Technology this past May.
          I am a detail-oriented, collaborative, and innovative student seeking for career opportunities in the tech industry with the
